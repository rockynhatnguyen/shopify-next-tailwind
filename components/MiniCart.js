                    ...
                    <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
...

                        {
                            ...
                            <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                                ...
                                <a
                                    href={checkoutUrl}
                                    className="flex items-center justify-center rounded-md border border-transparent bg-black px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-gray-800 transition-colors duration-300"
                                >
                                    Checkout
                                </a>
                                </div>
